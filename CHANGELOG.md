...
- **Breaking** Bump holochain dependencies to holochain-0.3.0-beta-dev.20
- Empty network info on loading
- Reactivly refetch agent profile info when route changes
