    ...
    match op.flattened::<EntryTypes, LinkTypes>()? {
            ...
            match delete_entry {
                OpDelete::Entry { original_action, original_app_entry, action } => {
                    match original_app_entry {
                        EntryTypes::Mew(mew) => {
                            validate_delete_mew(action, original_action, mew)
                        }
                    }
                }
                _ => Ok(ValidateCallbackResult::Valid),
        ...
        FlatOp::RegisterCreateLink {
            ...
            match link_type {
                ...
                LinkTypes::AgentMews => {
                    validate_create_link_agent_mews(
                        action,
                        base_address,
                        target_address,
                        tag,
                ...
                LinkTypes::MentionToMews => {
                    validate_create_link_mention_to_mews(
                        action,
                        base_address,
                        target_address,
                        tag,
                ...
                LinkTypes::HashtagToMews => {
                    validate_create_link_hashtag_to_mews(
                        action,
                        base_address,
                        target_address,
                        tag,
                ...
                LinkTypes::CashtagToMews => {
                    validate_create_link_cashtag_to_mews(
                        action,
                        base_address,
                        target_address,
                        tag,
        ...
        FlatOp::RegisterDeleteLink {
            ...
            match link_type {
                ...
                LinkTypes::AgentMews => {
                    validate_delete_link_agent_mews(
                        action,
                        original_action,
                        base_address,
                        target_address,
                ...
                LinkTypes::MewToResponses => {
                    validate_delete_link_mew_to_responses(
                        action,
                        original_action,
                        base_address,
                        target_address,
                ...
                LinkTypes::MentionToMews => {
                    validate_delete_link_mention_to_mews(
                        action,
                        original_action,
                        base_address,
                        target_address,
                ...
                LinkTypes::CashtagToMews => {
                    validate_delete_link_cashtag_to_mews(
                        action,
                        original_action,
                        base_address,
                        target_address,
