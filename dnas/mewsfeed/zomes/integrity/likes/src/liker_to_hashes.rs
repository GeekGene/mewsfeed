...
pub fn validate_create_link_liker_to_hashes(
    ...
    if base_address != AnyLinkableHash::from(action.author) {
        return Ok(ValidateCallbackResult::Invalid("You cannot change who others like".into()));
    }
...
pub fn validate_delete_link_liker_to_hashes(
    ...
    if action.author != original_action.author {
        return Ok(ValidateCallbackResult::Invalid("You cannot change who others unlike".into()));
    }
