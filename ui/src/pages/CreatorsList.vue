<template>
  <div>
    ...
    <h2
      class="text-xl font-title font-bold tracking-tighter mb-2 flex items-center justify-start space-x-4"
    >
      <div>
...
onBeforeRouteLeave(() => {
  if (data.value && data.value.pages.length > 1) {
    queryClient.setQueryData(
      ["mews", "get_creators_for_follower", route.params.agentPubKey],
      (d: any) => ({
        pages: [d.pages[0]],
